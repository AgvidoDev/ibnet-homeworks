...
```
Если ранее выдавалось предупреждение о небезопасном шифре, то теперь предупрежденией нет и подключение прошло штатно, но написано что в подключении отказано
```
